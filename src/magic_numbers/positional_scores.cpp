...
constexpr std::array<Score, 64> PieceSquareTables::RookScores = {0, 0,  0,  0,  0,  0, 0, 0, 5, 10, 10, 10, 10, 10, 10, 5, -5, 0,  0,  0, 0, 0,
                                                                 0, -5, -5, 0,  0,  0, 0, 0, 0, -5, -5, 0,  0,  0,  0,  0, 0,  -5, -5, 0, 0, 0,
                                                                 0, 0,  0,  -5, -5, 0, 0, 0, 0, 0,  0,  -5, 0,  0,  0,  5, 5,  0,  0,  0};

constexpr std::array<Score, 64> PieceSquareTables::QueenScores = {
...
constexpr std::array<Score, 64> PieceSquareTables::KingMidgameScores = {
...
constexpr std::array<Score, 64> PieceSquareTables::KingEndgameScores = {
