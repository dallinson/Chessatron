...
namespace TimeManagement {
    ...
    TUNABLE_SPECIFIER auto hard_limit_time_divisor = TUNABLE_INT("hard_limit_time_divisor", 8, 1, 20);
    ...
    TUNABLE_SPECIFIER auto soft_limit_multi = TUNABLE_FLOAT("soft_limit_multi", 0.2614, 0.1, 0.75);
    /**
