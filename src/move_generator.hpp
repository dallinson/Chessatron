...
namespace MoveGenerator {
    ...
    Bitboard generate_bishop_movemask(const ChessBoard &c, const int idx);
    Bitboard generate_rook_movemask(const ChessBoard &c, const int idx);
    Bitboard generate_queen_movemask(const ChessBoard &c, const int idx);
