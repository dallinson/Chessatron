...
class SearchHandler {
    private:
        ...
        Score run_aspiration_window_search(int depth, Score previous_score, int& max_ply, std::array<uint32_t, 8192>& history_table);
        template <NodeTypes node_type> Score negamax_step(Score alpha, Score beta, int depth, int ply, TranspositionTable& transpositions, int& max_ply, std::array<uint32_t, 8192>& history_table);
        template <NodeTypes node_type> Score quiescent_search(Score alpha, Score beta, int ply, TranspositionTable& transpositions, int& max_ply, std::array<uint32_t, 8192>& history_table);
