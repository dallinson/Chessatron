...
TEST(ZobristHashingTests, TestSimplePositionNonPawnHash) {
    Position pos;
    pos.set_from_fen("8/4k3/8/6K1/8/8/1P6/8 w - - 0 1");
    ASSERT_EQ(pos.white_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::KING), 38)]);
    ASSERT_EQ(pos.black_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 52)]);
...
TEST(ZobristHashingTests, TestEnPassantNonPawnHash) {
    Position pos;
    pos.set_from_fen("8/4k3/8/6K1/2p5/8/1P6/8 w - - 0 1");
    ASSERT_EQ(pos.white_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::KING), 38)]);
    ASSERT_EQ(pos.black_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 52)]);
...
TEST(ZobristHashingTests, TestPawnPromotionAndCaptureNonPawnHash) {
    Position pos;
    pos.set_from_fen("1p6/P3k3/8/6K1/8/8/8/8 w - - 0 1");
    ASSERT_EQ(pos.non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::KING), 38)] ^
                                       ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 52)]);
...
TEST(ZobristHashingTests, TestPawnPromotionCaptureNonPawnHash) {
    Position pos;
    pos.set_from_fen("1p6/P3k3/8/6K1/8/8/8/8 w - - 0 1");
    ASSERT_EQ(pos.white_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::KING), 38)]);
    ASSERT_EQ(pos.black_non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 52)]);
...
TEST(ZobristHashingTests, TestCastlingNonPawnHash) {
    Position pos;
    pos.set_from_fen("8/8/5k2/8/8/8/8/R3K2R w KQ - 0 1");
    ...
    ASSERT_EQ(pos.non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::ROOK), 0)] ^
                                       ...
                                       ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 45)]);
    pos = pos.make_move(Move(MoveFlags::QUIET_MOVE, 8, 0), hist);
    ASSERT_EQ(pos.non_pawn_hash(), ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::ROOK), 8)] ^
                                       ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::KING), 4)] ^
                                       ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::WHITE, PieceTypes::ROOK), 7)] ^
                                       ZobristKeys::PositionKeys[calculate_zobrist_key(Piece(Side::BLACK, PieceTypes::KING), 45)]);
    pos = hist.pop_board();
