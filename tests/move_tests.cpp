...
TEST(MoveTests, TestPromotionToString) {
    ...
    ASSERT_STREQ(std::format("{}", rook_promotion).c_str(), "a7a8r");
    ASSERT_STREQ(std::format("{}", rook_promotion_capture).c_str(), "a7b8r");
    ...
    ASSERT_STREQ(std::format("{}", knight_promotion).c_str(), "a7a8n");
    ASSERT_STREQ(std::format("{}", knight_promotion_capture).c_str(), "a7b8n");
    ...
    ASSERT_STREQ(std::format("{}", bishop_promotion).c_str(), "a7a8b");
    ASSERT_STREQ(std::format("{}", bishop_promotion_capture).c_str(), "a7b8b");
    ...
    ASSERT_STREQ(std::format("{}", queen_promotion).c_str(), "a7a8q");
    ASSERT_STREQ(std::format("{}", queen_promotion_capture).c_str(), "a7b8q");
}